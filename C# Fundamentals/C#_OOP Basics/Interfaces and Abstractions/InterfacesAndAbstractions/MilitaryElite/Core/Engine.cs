    ...
    public class Engine
    {
        ...
        public void Run()
        {
            ...
            while(input != "End")
            {
                ...
                {
                    decimal salary = decimal.Parse(inputArgs[4]);
                    soldier = GetEnigineer(id, firstName, lastName, salary, inputArgs);
                }
        ...
        private ISoldier GetEnigineer(int id, string firstName, string lastName, decimal salary, string[] inputArgs)
        {
            string corpsAsString = inputArgs[5];
